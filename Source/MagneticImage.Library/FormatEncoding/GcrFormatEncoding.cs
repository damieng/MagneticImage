...
/// <summary>
/// Represents the Group Coded Recording bit pattern translations.
/// </summary>
/// <remarks>
/// See <link>https://en.wikipedia.org/wiki/Group_coded_recording</link> for more information.
/// </remarks>
public class GcrFormatEncoding
{
    private static readonly List<BitPattern> table = new()
    {
