...
using MagneticImage.TextEncoding;
...
public class XmlDiskWriter
{
    ...
    private WriteContext CreateContext(DiskImage image)
    {
        ...
        return new WriteContext
        {
            DefaultTrack = new FormattedTrack
            {
                ...
                SectorCount = tracks.MostCommon(t => t.Sectors.Count)
            },
    ...
    private static int GetSectorDataLength(byte[] sectorData, byte filler)
    {
